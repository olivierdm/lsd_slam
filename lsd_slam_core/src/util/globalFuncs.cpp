...
#if OPENCV3
	cv::putText(image, line2, cv::Point(10,image.rows-5), cv::FONT_HERSHEY_SIMPLEX, 0.4, cv::Scalar(200,200,250), 1, 8);
 
	cv::putText(image, line1, cv::Point(10,image.rows-18), cv::FONT_HERSHEY_SIMPLEX, 0.4, cv::Scalar(200,200,250), 1, 8);
#else
	cv::putText(image, line2, cvPoint(10,image.rows-5), CV_FONT_HERSHEY_SIMPLEX, 0.4, cv::Scalar(200,200,250), 1, 8);

	cv::putText(image, line1, cvPoint(10,image.rows-18), CV_FONT_HERSHEY_SIMPLEX, 0.4, cv::Scalar(200,200,250), 1, 8);
#endif
}
